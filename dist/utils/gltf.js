...
exports.Vehicle = exports.Toyota = exports.Dozer = exports.Drill = void 0;
const THREE = __importStar(require("three"));
const web_1 = require("utils/web");
const { GLTFLoader } = require('three/addons/loaders/GLTFLoader.js');
const SkeletonUtils = require('three/addons/utils/SkeletonUtils.js');
const Loader = new GLTFLoader();
const Drill = ({ size = 50, x = 0, y = 0, z = 0 }) => new Promise((res) => {
...
exports.Drill = Drill;
const Dozer = ({ size = 50, x = 0, y = 0, z = 0 }) => new Promise((res) => Loader.load('./dozer/scene.gltf', (gltf) => {
...
exports.Dozer = Dozer;
const Toyota = ({ size = 50, x = 0, y = 0, z = 0 }) => new Promise((res) => Loader.load('./hilux.glb', (gltf) => {
    const scene = gltf.scene;
...
class Vehicle {
    ...
    remove = () => {
        try {
            ...
            web_1.log.error(`[Vehicle]: Remove / ${err.message}`);
        }
    };
}
