...
class MapView {
    ...
    constructor(conf) {
        ...
        if (!this.conf.hasOwnProperty('custom'))
            this.conf.custom = {};
        if (!this.conf.hasOwnProperty('customBase'))
        ...
        Delay(() => {
            ...
            this.threeLayer.prepareToDraw = (gl, scene, camera) => {
                ...
                const renderer = this.threeLayer.getThreeRenderer();
            ...
            const update = () => {
                ...
                this.mixers.forEach((mixer) => mixer && mixer.update(delta));
                TWEEN.update();
